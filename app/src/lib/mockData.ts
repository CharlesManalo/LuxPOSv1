...
export const demoProducts: Product[] = [
  {
    ...
    price: 95,
    image_url:
      "https://images.unsplash.com/photo-1603133872878-684f2d09c77c?w=400&h=400&fit=crop",
    is_available: true,
    description:
      "Tapa + Sinangag + Itlog. Our signature silog meal with marinated beef tapa.",
    has_variants: true,
    created_at: "2024-01-15T00:00:00Z",
  },
  {
    ...
    is_available: true,
    description:
      "Longganisa + Sinangag + Itlog. Sweet Filipino pork sausage with garlic rice and egg.",
    has_variants: true,
    created_at: "2024-01-15T00:00:00Z",
  },
  {
    ...
    price: 105,
    image_url:
      "https://images.unsplash.com/photo-1519708227418-c8fd9a3a270b?w=400&h=400&fit=crop",
    is_available: true,
    description:
      "Bangus + Sinangag + Itlog. Fried milkfish served with garlic rice and sunny-side up egg.",
    has_variants: false,
    created_at: "2024-01-15T00:00:00Z",
  },
  {
    ...
    price: 80,
    image_url:
      "https://images.unsplash.com/photo-1547424450-75ec164925ad?w=400&h=400&fit=crop",
    is_available: true,
    description:
      "Hotdog + Sinangag + Itlog. Classic Filipino breakfast hotdog with garlic rice and egg.",
    has_variants: false,
    created_at: "2024-01-15T00:00:00Z",
  },
  {
    ...
    is_available: true,
    description:
      "Chicken + Sinangag + Itlog. Crispy fried chicken with garlic rice and egg.",
    has_variants: true,
    created_at: "2024-01-15T00:00:00Z",
  },
  {
    ...
    is_available: true,
    description: "Refreshing iced coffee made with Barako beans.",
    has_variants: true,
    created_at: "2024-01-15T00:00:00Z",
  },
  {
    ...
    is_available: true,
    description: "Fresh calamansi juice, perfectly sweet and sour.",
    has_variants: true,
    created_at: "2024-01-15T00:00:00Z",
  },
  {
  ...
  },
  {
    ...
    is_available: true,
    description: "Additional sunny-side up egg.",
    has_variants: false,
    created_at: "2024-01-15T00:00:00Z",
  },
  {
  ...
  },
  {
    ...
    is_available: true,
    description: "2 Silog meals + 2 drinks. Perfect for sharing!",
    has_variants: true,
    created_at: "2024-01-15T00:00:00Z",
  },
  {
    ...
    is_available: true,
    description: "4 Silog meals + 4 drinks + 4 extra rice. Sulit!",
    has_variants: true,
    created_at: "2024-01-15T00:00:00Z",
  },
];
